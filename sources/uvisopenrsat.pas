...
begin
  MenuItem_ViewThemeDark.Checked := FrmRSAT.RsatOptions.Theme = tmDark;
  MenuItem_ViewThemeLight.Checked := FrmRSAT.RsatOptions.Theme = tmLight;
  MenuItem_ViewThemeSystem.Checked := FrmRSAT.RsatOptions.Theme = tmSystem;
end;
...
begin
  ...
  {$IFDEF WINDOWS}
  if FrmRSAT.RsatOptions.Theme = tmDark then
    PreferredAppMode := pamForceDark
  else if FrmRSAT.RsatOptions.Theme = tmLight then
