...
begin
  ...
  try
    ...
    begin
      if not WELL_KNOWN_SID_NAMES[ksid].ToLower.Contains(lFilter) and not String(RawSidToText(KnownRawSid(ksid))).ToLower.Contains(lFilter) then
        continue;
