...
resourcestring
  ...
  rsModuleGPODisplayName = 'Group Policy';

  // GPO module
  rsGPONewTitle = 'New GPO';
  rsGPONewPrompt = 'Display name of the new GPO:';
  rsGPORenameTitle = 'Rename GPO';
  rsGPORenamePrompt = 'New display name of the GPO:';
  rsGPODeleteTitle = 'Delete GPO';
  rsGPODeleteConfirmation = 'Do you want to delete the GPO "%"?';
  rsGPOStatusAllEnabled = 'All settings enabled';
  rsGPOStatusUserDisabled = 'User configuration settings disabled';
  rsGPOStatusMachineDisabled = 'Computer configuration settings disabled';
  rsGPOStatusAllDisabled = 'All settings disabled';
  rsGPOTabSummary = 'Summary';
  rsGPOTabConfiguration = 'Configuration';
  rsGPOTabCatalog = 'Catalog';
  rsGPOTabTechnical = 'Technical';
  rsGPONotImplemented = 'This feature is not implemented yet.';
  rsGPOUserVersion = 'User version';
  rsGPOMachineVersion = 'Machine version';
  rsGPOFunctionalityVersion = 'Functionality version';
  rsGPOStatus = 'Status';
  rsGPOFilePath = 'Path';
  rsGPOList = 'Group Policy Objects';
  rsGPOElementsCount = 'Total: % elements';
  rsGPOActionRefresh = 'Refresh';
  rsGPOActionCreate = 'New GPO';
  rsGPOActionDuplicate = 'Duplicate';
  rsGPOActionDuplicateNotImplemented = 'Duplicating a GPO is not implemented yet.';
  rsGPOConfigurationDescription = 'Description';
  rsGPOConfigurationWQLFilter = 'WMI Filter';
  rsGPOConfigurationUserExtensions = 'User extensions';
  rsGPOConfigurationMachineExtensions = 'Machine extensions';
  rsGPOConfigurationApply = 'Apply';
  rsGPOConfigurationReset = 'Reset';
  rsGPOConfigurationUpdated = 'Configuration of the GPO updated.';
  rsGPOConfigurationFailed = 'Unable to update the configuration of the GPO.';
  rsGPOConfigurationSave = 'Save';
  rsGPOConfigurationDiscard = 'Discard changes';
  rsGPOConfigurationStaged = 'Staged';
  rsGPOConfigurationNoGPOSelected = 'No GPO selected';
  rsGPOConfigurationStage = 'Stage';
  rsGPOConfigurationStagedChanges = 'Staged changes: %';
  rsGPOConfigurationStagedEmpty = 'No staged changes.';
  rsGPOConfigurationIncrementUser = 'Increment user version on save';
  rsGPOConfigurationIncrementMachine = 'Increment machine version on save';
  rsGPOConfigurationSaved = 'GPO changes saved.';
  rsGPOConfigurationDiscardConfirmation = 'Discard all staged changes?';
  rsGPOConfigurationUpdateGptIni = 'Update GPT.INI on SYSVOL on save';
  rsGPOConfigurationSource = 'Source';
  rsGPOConfigurationSourceGPC = 'GPC parameters';
  rsGPOConfigurationSourceUser = 'User Registry.pol';
  rsGPOConfigurationSourceMachine = 'Machine Registry.pol';
  rsGPOConfigurationRegKey = 'Key';
  rsGPOConfigurationRegHint = 'Select a key, then edit its values.';
  rsGPOConfigurationRegApply = 'Apply';
  rsGPOConfigurationRegDelete = 'Delete';
  rsGPOConfigurationRegAddKey = 'Key';
  rsGPOConfigurationRegAddKeyPrompt = 'Full path of the new key (e.g. Software\Policies\Test):';
  rsGPOConfigurationRegValueName = 'Name';
  rsGPOConfigurationRegValueType = 'Type';
  rsGPOConfigurationRegValueData = 'Value';
  rsGPOConfigurationRegInvalidDWord = 'The value must be a 32-bit number.';
  rsGPOConfigurationRegInvalidQWord = 'The value must be a 64-bit number.';
  rsGPOConfigurationRegWriteFailed = 'Unable to write the Registry.pol on the SYSVOL.';
  rsGPODuplicatePrompt = 'Display name of the duplicated GPO:';
  rsGPOConfigurationParameterName = 'Parameter';
  rsGPOConfigurationParameterValue = 'Value';
  rsGPOCatalogAdd = 'Add to GPO';
  rsGPOCatalogAddPrompt = 'Value of the parameter "%":';
  rsGPOCatalogAlreadyExists = 'The parameter "%" already exists on this GPO.';
  rsGPOCatalogColumnName = 'Parameter';
  rsGPOCatalogColumnDescription = 'Description';
  rsGPOCatalogDisplayName = 'Display name of the GPO.';
  rsGPOCatalogDescription = 'Description of the GPO.';
  rsGPOCatalogFileSysPath = 'UNC path of the GPT in the SYSVOL.';
  rsGPOCatalogVersionNumber = 'Version of the GPO (user in the low word, machine in the high word).';
  rsGPOCatalogFunctionalityVersion = 'Functionality version (2 = Windows 2008+).';
  rsGPOCatalogFlags = 'Status of the GPO (enabled, user disabled, machine disabled, all disabled).';
  rsGPOCatalogWQLFilter = 'DN of the WMI filter applied to the GPO.';
  rsGPOCatalogUserExtensions = 'User-side extensions (CSEs) of the GPO.';
  rsGPOCatalogMachineExtensions = 'Machine-side extensions (CSEs) of the GPO.';
  rsGPOCatalogWhenCreated = 'Creation date of the GPO.';
  rsGPOCatalogWhenChanged = 'Last modification date of the GPO.';
  rsGPOCatalogCN = 'Name of the GPO container (GUID).';
  rsGPOCatalogDistinguishedName = 'Distinguished name of the GPO.';
  rsGPOCatalogShowInAdvanced = 'Show the GPO in the advanced view only.';
  rsGPOSummaryTotalAttributes = 'Total parameters';
  rsGPOSummaryKnownAttributes = 'Known parameters';
  rsGPOSummaryUnknownAttributes = 'Unknown parameters';
  rsGPOSummaryUserTechnologies = 'User-side technologies';
  rsGPOSummaryMachineTechnologies = 'Machine-side technologies';
  rsGPOTechnicalGPTFiles = 'GPT files';
  rsGPOTechnicalGPTFilesRefresh = 'List GPT files';
  rsGPOTechnicalGPTFileColumn = 'File';
  rsGPOTechnicalGPTSizeColumn = 'Size';
  rsGPOTechnicalGPTUnavailable = 'GPT not reachable (smbclient missing or no credentials).';
  rsGPOTechnicalGPTEmpty = 'The GPT is empty or could not be read.';
  rsGPOTechnicalGPTIniRead = 'Read GPT.INI';
  rsGPOTechnicalGPTIniUnavailable = 'GPT.INI not reachable (smbclient missing or no credentials).';
  rsGPOTechnicalGPTIniEmpty = 'GPT.INI exists but its [General] section is empty.';
  rsGPOTechnicalGPTIniUpdateFailed = 'Unable to update the GPT.INI on the SYSVOL.';
  rsGPOTechnicalGPTIniVersion = 'Version';
  rsGPOTechnicalGPTIniDisplayName = 'Display name';
  rsGPOTechnicalGPTIniOptions = 'Options';
